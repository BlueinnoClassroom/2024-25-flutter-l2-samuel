const xy12 = [
  ...
  },
  {
    ...
    "attacks": [
      {
        "name": "Crimson Dive",
        "cost": ["Fire", "Fire", "Colorless", "Colorless", "Colorless"],
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "Switch 1 of your opponent's Benched Pokémon with his or her Active Pokémon. The new Active Pokémon can't retreat during your opponent's next turn."
      },
      {
        "name": "Fire Blast",
        "cost": ["Fire", "Fire", "Colorless"],
    ...
    "attacks": [
      {
        ...
        "damage": "100+",
        "text":
            "This Pokémon is now Confused. During your next turn, this Pokémon's Loll Roll Spin attack does 100 more damage (before applying Weakness and Resistance)."
      }
    ],
    "weaknesses": [
      {"type": "Grass", "value": "×2"}
  ...
  },
  {
    ...
    "attacks": [
      ...
      },
      {
        ...
        "damage": "100",
        "text":
            "This attack does 20 damage to each of your opponent's Benched Basic Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)"
      }
    ],
    "weaknesses": [
      {"type": "Psychic", "value": "×2"}
  ...
  },
  {
    ...
    "attacks": [
      ...
      },
      {
        ...
        "damage": "80",
        "text":
            "If your opponent's Active Pokémon is not Asleep, this attack does nothing."
      }
    ],
    "weaknesses": [
      {"type": "Darkness", "value": "×2"}
    ...
    "attacks": [
      {
        ...
        "damage": "10",
        "text":
            "Flip a coin. If heads, your opponent's Active Pokémon is now Poisoned. If tails, your opponent's Active Pokémon is now Confused."
      }
    ],
    "weaknesses": [
      {"type": "Psychic", "value": "×2"}
    ...
    "attacks": [
      {
        ...
        "damage": "60-",
        "text":
            "This attack does 60 damage minus 10 damage for each damage counter on this Pokémon."
      },
      {
        "name": "Submission",
        "cost": ["Fighting", "Fighting", "Fighting"],
    ...
    "abilities": [
      {
        ...
        "text":
            "When you play this Pokémon from your hand onto your Bench, you may discard all Pokémon Tool cards attached to your opponent's Active Pokémon.",
        "type": "Ability"
      }
    ],
    "attacks": [
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "Choose Grass, Fire, Water, Lightning, Psychic, Fighting, Darkness, Metal, Fairy, or Dragon type. The Defending Pokémon's Weakness is now that type until the end of your next turn. (The amount of Weakness doesn't change.)"
      }
    ],
    "weaknesses": [
      {"type": "Fighting", "value": "×2"}
    ...
    "attacks": [
      {
        ...
        "damage": "20+",
        "text":
            "コインを1回投げオモテなら、10ダメージを追加。 Flip a coin. If heads, this attack does 10 more damage."
      }
    ],
    "weaknesses": [
      {"type": "Fire", "value": "×2"}
  ...
  },
  {
    ...
    "hp": "50",
    "types": ["Colorless"],
    "rules": ["(This card cannot be used at official tournaments.)"],
    "abilities": [
      {
        "name": "Frenzied Escape",
        "text":
            "When this Doduo retreats, hold this card and throw it as hard as you can because Doduo is running away. Throw the card horizontally with a snap to get the farthest distance!",
        "type": "Pokémon Power"
      }
    ],
    "attacks": [
