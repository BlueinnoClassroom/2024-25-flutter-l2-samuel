const xy6 = [
    ...
    "attacks": [
      {
        ...
        "damage": "20×",
        "text":
            "This attack does 20 damage times the number of Colorless Pokémon your opponent has in play."
      },
      {
        "name": "Seed Bomb",
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "Search your deck for Wurmple and put it onto your Bench. Shuffle your deck afterward."
      },
      {
        "name": "Tackle",
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "Put 1 damage counter on each of your opponent's Pokémon. Switch this Pokémon with 1 of your Benched Pokémon."
      },
      {
        ...
        "damage": "50×",
        "text":
            "This attack does 50 damage times the number of damage counters on this Pokémon."
      }
    ],
    "retreatCost": ["Colorless"],
    "convertedRetreatCost": 1,
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "Search your deck for up to 3 Water Energy cards, reveal them, and put them into your hand. Shuffle your deck afterward."
      },
      {
        "name": "Freezing Wind",
  ...
  },
  {
    ...
    "attacks": [
      ...
      },
      {
        ...
        "damage": "70",
        "text":
            "You may move all Energy from this Pokémon to your Benched Pokémon in any way you like."
      }
    ],
    "weaknesses": [
      {"type": "Fighting", "value": "×2"}
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "If you go first, you can use this attack on your first turn. Draw 2 cards."
      },
      {
    ...
    "abilities": [
      {
        "name": "Cursed Eyes",
        "text":
            "When you play this Pokémon from your hand onto your Bench, you may move 3 damage counters from 1 of your opponent's Pokémon to another of his or her Pokémon.",
        "type": "Ability"
      }
    ],
    "attacks": [
    ...
    "abilities": [
      {
        "name": "Serene Grace",
        "text":
            "When you play this Pokémon from your hand to evolve 1 of your Pokémon, you may look at the top 8 cards of your deck. Choose any basic Energy cards you find there and attach them to your Pokémon in any way you like. Shuffle the other cards back into your deck.",
        "type": "Ability"
      }
    ],
    "attacks": [
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "Reveal cards from the top of your deck until you reveal an Item card. Put it into your hand. Shuffle the other cards back into your deck."
      },
      {
        "name": "Play Rough",
    ...
    "abilities": [
      {
        "name": "Max Wind",
        "text":
            "When you play this Pokémon from your hand to evolve 1 of your Pokémon, you may heal all damage from 1 of your Pokémon.",
        "type": "Ability"
      }
    ],
    "attacks": [
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "Attach up to 2 basic Energy cards from your hand to this Pokémon."
      },
      {
        "name": "Heavy Impact",
        "cost": ["Grass", "Grass", "Grass", "Lightning", "Colorless"],
    ...
    "abilities": [
      {
        "name": "Exoskeleton",
        "text":
            "Any damage done to this Pokémon by attacks is reduced by 10 (after applying Weakness and Resistance).",
        "type": "Ability"
      }
    ],
    "attacks": [
  ...
  },
  {
    ...
    "ancientTrait": {
      "name": "Δ Wild",
      "text":
          "Any damage done to this Pokémon by attacks from your opponent's Grass, Fire, Water, or Lightning Pokémon is reduced by 20 (after applying Weakness and Resistance)."
    },
    "attacks": [
      {
        "name": "Dragon Ascent",
        "cost": ["Fire", "Fire", "Fire", "Lightning", "Colorless"],
        "convertedEnergyCost": 5,
        "damage": "300",
    ...
    "abilities": [
      {
        "name": "Dragon Road",
        "text":
            "If there is any Stadium card in play, the Retreat Cost of each of your Dragon Pokémon in play is ColorlessColorless less.",
        "type": "Ability"
      }
    ],
    "attacks": [
    ...
    "abilities": [
      {
        "name": "Turboblaze",
        "text":
            "Once during your turn (before your attack), if this Pokémon is your Active Pokémon, you may attach a Fire Energy card from your hand to 1 of your Dragon Pokémon.",
        "type": "Ability"
      }
    ],
    "attacks": [
  ...
  },
  {
    ...
    "attacks": [
      ...
      },
      {
        ...
        "damage": "",
        "text":
            "Shuffle all cards attached to each player's Pokémon into that player's deck."
      }
    ],
    "weaknesses": [
      {"type": "Lightning", "value": "×2"}
