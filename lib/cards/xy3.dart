    ...
    "abilities": [
      {
        "name": "Wafting Scent",
        "text":
            "Once during your turn (before your attack), you may discard a Grass Energy attached to this Pokémon. If you do, your opponent's Active Pokémon is now Confused and Poisoned.",
        "type": "Ability"
      }
    ],
    "attacks": [
  ...
  },
  {
    ...
    "attacks": [
      ...
      },
      {
        ...
        "damage": "80+",
        "text":
            "If Electivire is on your Bench, this attack does 80 more damage."
      }
    ],
    "weaknesses": [
      {"type": "Water", "value": "×2"}
  ...
  },
  {
    ...
    "attacks": [
      ...
      },
      {
        ...
        "damage": "50+",
        "text":
            "If your opponent's Active Pokémon already has any damage counters on it, this attack does 50 more damage."
      }
    ],
    "weaknesses": [
      {"type": "Grass", "value": "×2"}
    ...
    "attacks": [
      {
        ...
        "damage": "30",
        "text":
            "This Pokémon does 10 damage to each of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)"
      },
      {
        "name": "Ice Edge",
        "cost": ["Water", "Colorless", "Colorless"],
    ...
    "abilities": [
      {
        "name": "Ice Shield",
        "text":
            "Any damage done by an opponent's attack to each of your Water Pokémon that has any Water Energy attached to it is reduced by 20 (after applying Weakness and Resistance).",
        "type": "Ability"
      }
    ],
    "attacks": [
    ...
    "attacks": [
      {
        ...
        "damage": "20+",
        "text":
            "This attack does 20 more damage for each Energy attached to your Magmortar."
      },
      {
        "name": "Gigavolt",
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "Discard a basic Energy card from your hand. If you do, draw 2 cards."
      },
      {
        "name": "Electric Tail",
        "cost": ["Lightning", "Colorless"],
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "Your opponent reveals his or her hand. You may choose a Supporter card you find there. If you do, your opponent plays that Supporter card. However, you make all decisions for that card. (That Supporter card is discarded.)"
      },
      {
        "name": "Hypnoblast",
    ...
    "attacks": [
      {
        ...
        "damage": "60+",
        "text":
            "If there is any Stadium card in play, this attack does 60 more damage. Discard that Stadium card."
      },
      {
        "name": "Golurk Hammer",
    ...
    "abilities": [
      {
        "name": "Fighting Fury",
        "text":
            "Each of your Fighting Pokémon's attacks do 20 more damage to your opponent's Active Pokémon (before applying Weakness and Resistance).",
        "type": "Ability"
      }
    ],
    "attacks": [
    ...
    "attacks": [
      {
        ...
        "damage": "",
        "text":
            "If you have any Darkness Pokémon on your Bench, search your deck for a card that evolves from this Pokémon and put it onto this Pokémon. (This counts as evolving this Pokémon.) Shuffle your deck afterward."
      },
      {
        "name": "Confront",
        "cost": ["Fighting", "Colorless", "Colorless"],
